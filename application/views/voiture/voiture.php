...
<?php echo anchor('voiture/add_voiture', '<span>Ajouter voiture</span>', 'aligne="center" class="ka_button small_button small_coolblue" id="test"'); ?>
<script>
		...
		<?php
			if(count($results) > 0){
				foreach ($results as $r) {
					...
					echo "	<td>".anchor('voiture/modifier_voiture/'.$r->id, '<span>Modifier</span>', 'class="ka_button small_button small_periwinkle" id="test"')."</td>
