	...
	<div class="one_third">
		...
		<div class="iphorm-outer">
			<?php 
				...
				echo form_open('service/modifier_service/'.classe()->id , $attributes);
            ?>
                ...
                <div class="iphorm-inner">
                    ...
                    <div class="iphorm-container clearfix">
                        ...
                        <div class="element-wrapper name-element-wrapper clearfix">
                            ...
                            <?php echo "<input id='id' name='id' value=".$results[0]->id.">";?>
                            <div class="input-wrapper name-input-wrapper">
                                <?php echo "<input class='name-element' id='libelle' type='text' name='libelle' value=".$results[0]->libelle.">";?>
                            </div>
                        </div>
                        <!-- End libelle element -->
                        ...
                        <div class="element-wrapper name-element-wrapper clearfix">
                            ...
                            <div class="input-wrapper name-input-wrapper">
                                <?php echo'<input class="name-element" id="regate" type="text" name="regate" value='.$results[0]->REGATE.'>';?>
                            </div>
                        </div>
                        <!-- End REGATE element -->
                        ...
                        <div class="element-wrapper disponible-element-wrapper clearfix">
                            ...
                            <?php 
                            if($results[0]->option_registre == true)
                            {
                                echo'<input class="option_registre-element" id="option_registre" type="checkbox" name="option_registre" value="1" checked>';
                            }
                            else
                            {
                                echo'<input class="option_registre-element" id="option_registre" type="checkbox" name="option_registre" value="1">';
                            }?>
                        </div>
