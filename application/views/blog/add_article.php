		...
		<div class="one_third">
			<div class="iphorm-outer">
				<?php 
    			    ...
    			    echo form_open('blog/add_article' , $attributes);
                ?>
                        ...
                        <div class="iphorm-container clearfix">
                            ...
                            <div class="element-wrapper name-element-wrapper clearfix">
                                ...
                                <div class="input-wrapper name-input-wrapper">
                                    <?php echo "<input class='name-element' id='titre' type='text' name='titre' >";?>
                                </div>
                            </div>
                            <!-- End titre element -->
                            ...
                            <div class="element-wrapper name-element-wrapper clearfix">
                                ...
                                <div class="input-wrapper name-input-wrapper">
                                    <?php echo'<textarea class="name-element" id="article" type="text" name="article" ></textarea>';?>
                                </div>
                            </div>
                            <!-- End article element -->
                            <!-- Begin Submit button -->
